...
class ReputationSystem(object):
    ...
    def check_chat_entry(self, chat_id):
        if chat_id not in self.data.keys():
            self.data[chat_id] = { 'last_message_id':{'me':None, 'toplvl':None, 'toprep': None, 'w':None, 'l':None, 'super':None, 'addlvl':None, 'set':None, 'status':None, 'levels':None, 'rmvlvl':None, 'apis':None}, 'levels' : {}, 'members' : {} }
            self.save()
